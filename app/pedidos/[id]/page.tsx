            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="bg-sucess hover:bg-sucess/60 text-white px-6 py-2.5 rounded-lg font-medium transition-colors"
                >
                  Finalizar
                </button>
                <button 
                  onClick={handleCancelar}
                  className="bg-error hover:bg-error/60 text-white px-6 py-2.5 rounded-lg font-medium transition-colors"
                >
                  Cancelar
                </button>
                <button className="bg-title hover:bg-title/50 text-white px-6 py-2.5 rounded-lg font-medium flex items-center gap-2 transition-colors">
                  Editar
